...
public class JA_RetrieveErrorsForObject extends CustomJavaAction<java.util.List<IMendixObject>>
{
	private IMendixObject MxObject;
	private java.lang.Boolean RemoveFeedback;

	public JA_RetrieveErrorsForObject(IContext context, IMendixObject MxObject, java.lang.Boolean RemoveFeedback)
	{
		super(context);
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		List<IMendixObject> listOfErrors = validationList.stream()
			.filter(feedback -> feedback.guid().equals(this.MxObject.getId().toLong()))
	...
	{
		return "JA_RetrieveErrorsForObject";
	}
