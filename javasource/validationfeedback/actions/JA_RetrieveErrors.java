...
public class JA_RetrieveErrors extends CustomJavaAction<java.util.List<IMendixObject>>
{
	private java.lang.Boolean RemoveFeedback;

	public JA_RetrieveErrors(IContext context, java.lang.Boolean RemoveFeedback)
	{
		super(context);
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		if(this.RemoveFeedback) {
			this.removeFeedback(validationList);
		}
